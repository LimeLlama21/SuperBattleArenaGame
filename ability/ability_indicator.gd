...
static func update_line_indicator(indicator: Node3D, target_pos: Vector3, rot_y: float) -> void:
	if is_instance_valid(indicator):
		indicator.global_position = Vector3(target_pos.x, 0.06, target_pos.z)
